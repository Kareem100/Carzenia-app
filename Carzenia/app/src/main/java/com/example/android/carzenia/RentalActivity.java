...
public class RentalActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.spinner_rent_form);
        image = findViewById(R.id.image_view_rented_car);
        typeTxt = findViewById(R.id.text_view_rented_car_type);
        occasionTxt = findViewById(R.id.text_view_rented_car_occasion);
        priceTxt = findViewById(R.id.text_view_rented_car_price);
        ...
        if(arrayList.isEmpty())
            Toast.makeText(this, "Sorry Still No Cars To Be Rented !!",
        ...
        rent =(Button) findViewById(R.id.button_confirm_rent);
        DateTo =(Button) findViewById(R.id.button_date_to);
        Button DateFrom = (Button) findViewById(R.id.button_date_from);

        DateFrom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datepicker = new DatePickerDialog(RentalActivity.this,
                        android.R.style.Theme_Holo_Light_Dialog_MinWidth,d2,CurrentYear,CurrentMonth,CurrentDay);
        ...
        d2=new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                if(dfYear >=CurrentYear && dfMonth >=CurrentMonth && dfDay >=CurrentDay)
                {
                    ...
                    TextView showselecteddate = (TextView) findViewById(R.id.text_view_date_from);
                    showselecteddate.setText(Cureentdate);
                    DateTo.setVisibility(View.VISIBLE);
                    ((TextView) findViewById(R.id.text_view_date_to)).setVisibility(View.VISIBLE);
                }
                else
                {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                if((dtYear>=dfYear))
                {
                    if( (dtDay==dfDay && dtMonth == dfMonth && dtYear == dfYear) ||
                            (dtMonth < dfMonth && dtYear == dfYear) ||
                            (dtDay < dfDay && dtMonth == dfMonth && dtYear == dfYear))
                        Toast.makeText(RentalActivity.this,"Not valid date",
                                Toast.LENGTH_LONG).show();
                    else {
                        SimpleDateFormat s=new SimpleDateFormat("dd/MM/yyyy");
                        Calendar c = Calendar.getInstance();
                        ...
                        c.set(Calendar.DAY_OF_MONTH,dayOfMonth);
                        String Cureentdate = s.format(c.getTime());
                        TextView showselecteddate = (TextView) findViewById(R.id.text_view_date_to);
                        showselecteddate.setText(Cureentdate);
                        TextView price=(TextView) findViewById(R.id.text_view_total_rent_cost);
                        int hourCost = 1;
        ...
        rent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String T1 = ((TextView)findViewById(R.id.text_view_date_from)).getText().toString();
                String T2 = ((TextView)findViewById(R.id.text_view_date_to)).getText().toString();
                if(T1.isEmpty() || T2.isEmpty())
                    Toast.makeText(RentalActivity.this, "Please Specify The Rental Duration !!",
                            Toast.LENGTH_LONG).show();
                else
                    showAlertDialog();
            }
    ...
    private void showAlertDialog(){
        ...
        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(RentalActivity.this, "Rented Successfully",
                        Toast.LENGTH_LONG).show();
            }
        });
